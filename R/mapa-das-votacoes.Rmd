...
bancada_bala <- read.table("~/Projetos/houseofcunha/bancada-bala.csv", header=TRUE, quote="\"")
bancada.humanista <- read.table("~/Projetos/houseofcunha/bancada-humanista.csv", header=TRUE, quote="\"")
```
...
# Arthur Maia não aparece nos dados da gente 
mca1_obs_df$destaque_bancada_bala <-  mca1_obs_df$nome %in% bancada_bala$Bala
...
# Bancada Evangelica 
bancada.evangelica <- read.table("~/Projetos/houseofcunha/bancada-evangelica.csv", header=TRUE, quote="\"")
mca1_obs_df$destaque_bancada_evangelica <- mca1_obs_df$nome %in% bancada.evangelica$Evangelica

# Bancada Ruralista
bancada.ruralista <- read.table("~/Projetos/houseofcunha/bancada-ruralista.csv", header=TRUE, quote="\"")
mca1_obs_df$destaque_bancada_ruralista <- mca1_obs_df$nome %in% bancada.ruralista$Ruralista

# Bancada Sindical
bancada.sindical <- read.table("~/Projetos/houseofcunha/bancada-sindical.csv", header=TRUE, quote="\"")
