...
cassacao.cunha <- read.table("~/Projetos/houseofcunha/cassacao-cunha.csv", header=TRUE, quote="\"")

# Bancadas
bancada.bala <- read.table("~/Projetos/houseofcunha/bancada-bala.csv", header=TRUE, quote="\"")
