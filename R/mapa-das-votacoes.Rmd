...
p <- ggplot(as.data.frame(table(quant_tipo_pro$tipo)), aes(Var1, Freq)) + geom_bar(stat = "identity") +
...
quant_tipo$tipo <- as.character(quant_tipo$tipo)
p <-ggplot(as.data.frame(table(quant_tipo$tipo)), aes(Var1, Freq)) + geom_bar(stat = "identity") +
