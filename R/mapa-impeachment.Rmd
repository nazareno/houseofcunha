...
p <- ggplot(data = group, 
  ...
  scale_y_continuous(limit = c(0, 1700000), 
                     breaks = c(0, 340000, 680000, 1020000, 1360000, 1700000),
                     labels = c("0", "340 mil", "680 mil", "1020 mil", "1360 mil", "1700 mil")) +
  labs(y='Valor doado por empresas da lava jato em reais', x='') +
  theme(axis.ticks.x = element_blank(), 
        axis.text = element_text(size = rel(1.5)), legend.position="none") + 
  coord_flip()

png("plot/impeachment/comissao_impeachment_doacao_lava_jato_valores_destaque_partido_15.png", width = 950, height = 600)
p 
dev.off()
