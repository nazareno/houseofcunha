...
png("plot/fidelidade/concordancia_governo_partidos_3.png", width = 800, height = 600)
p
dev.off()
```
...
png("plot/fidelidade/fidelidade_partidaria_centrao_3.png", width = 800, height = 600)
p
dev.off()
```
...
png("plot/fidelidade/mapa_centrao_1.png", width = 800, height = 600)
p
dev.off()
